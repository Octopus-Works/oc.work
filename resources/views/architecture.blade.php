...
<body class="architect">
  ...
  <header>
    ...
    <!-- Intro Section -->
    <section class="view intro-2 test ">
        <div id="container" class="z-depth h-100 justify-content-center align-items-center">
          <div class="test z-depth-2 h-100 justify-content-center align-items-center wow fadeInRightBig"
            data-wow-delay="0" style="background-image: url('../img/Architecture/Architecture.png');">
           
              <div id="moveing" class="test moveing  h-100 justify-content-center align-items-center wow fadeInUpBig"
                data-wow-delay="1s" style="background-image: url('../img/Architecture/Architecture1.png');">
              </div>
            </div>
          </div>
        </div>
  ...
  <main>
    ...
    <div class="container">
      ...
      <section id="services" class="section feature-box pt-3 pb-4">
        ...
        <!-- Secion heading -->
        <h1 class="text-center text-uppercase  font-weight-bold custom-primary-text custom-primary-text  mt-5 mb-3 mt-4 wow fadeIn" data-wow-delay="0.2s"> Services</h1>
    ...
    <div class="streak streak-photo streak-md"
      ...
      <div class="mask flex-center rgba-stylish-strong">
        ...
        <div class="white-text smooth-scroll wow fadeIn" data-wow-delay="0.2s">
          ...
          <h3 class="text-center h3-responsive mb-5"><i class="fas fa-quote-left" aria-hidden="true"></i> Lorem ipsum
    ...
    <div class="container-fluid" style="background-color: #e8eaec;">
      ...
      <div class="container-fluid">
        ...
        <section id="portfolio" class="section pt-3 pb-3">
          ...
          <h1 class="text-center text-uppercase  font-weight-bold custom-primary-text mt-5 mb-3 mt-5 wow fadeIn" data-wow-delay="0.2s">OUR

            projects</h1>

          <!-- Section description -->
          <p class="text-center w-responsive mx-auto text-uppercase  font-weight-bold custom-primary-text wow fadeIn" data-wow-delay="0.2s">
            All
          ...
          <div class="row ml-3 mr-3 pb-4 pt-1 wow fadeIn" data-wow-delay="0.4s">
            ...
            <!-- First column -->
            <div class="row pt-5 mb-4 center-text">
