...
@media screen and (min-width: 800px) {
  .img1 {
      ...
      background-size: cover;
      background-position: center center;
      background-image: url('../img/chairman letter/frame.png');
    }
    .img2 {
      background-position: center;
      background-repeat: no-repeat;
      background-size: cover;
      background-position: center center;
      background-image: url('../img/chairman letter/photo.png');
    }
    .img3 {
      background-position: center;
      background-repeat: no-repeat;
...
<body class="designer">
  ...
  <header>
    ...
    <div id="container" class="view jarallax custom-primary"  data-jarallax='{"speed": 0.2}'>
        <div class="img2  h-100   wow fadeInRightBig" data-wow-delay="0" >
          <div id="moveing" class="img1 moveing   h-100   wow fadeInLeftBig"  data-wow-delay="0.5s" > 
          </div>
        </div>
      <div class="mask ">
                            ...
                            <div class="card pb-5 mx-md-3">
                                <div class="card-body">
                                    ...
                                    <div class="container">
                                        ...
                                        <!--Section heading-->
                                        <h1 class="text-center h1 pt-4 mb-3 custom-primary-text">
                                            <strong>Chairman Letter</strong>
                                        </h1>
