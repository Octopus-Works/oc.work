...
.icon-area .circle-icon i{-webkit-box-shadow:0 8px 19px #a31621;box-shadow:0 8px 19px #a31621;width:100px;height:100px;line-height:1.4;padding:1.8rem;font-size:2rem;-webkit-border-radius:50%;border-radius:50%;background:#fff;}
.icon-area .circle-icon i:hover{background:#ebeef9;}
...
.rgba-indigo-strong,.rgba-indigo-strong:after{background-color:rgba(63,81,181,.7);}
...
.streak.streak-md{height:300px;}
}
.streak.streak-photo{background-repeat:no-repeat;-webkit-background-size:cover;background-size:cover;background-position:center;}
@media (min-width:1366px){
.streak.streak-photo{background-attachment:fixed;}
}
.mask{background-attachment:fixed;}
/*! CSS Used keyframes */
    ...
    <div class="row">
      ...
      <div class="col-lg-5 mb-lg-0 mb-4">
        ...
        <div class="card">
          <div class="card-body">
            <!-- Header -->
            <div class="form-header blue custom-primary">
      ...
      <div class="col-lg-7">
        ...
        <div id="map-container-section" class="z-depth-1-half map-container-section mb-4" style="height: 400px">
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13308.712898099073!2d36.2332103!3d33.4967399!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xd8288f0a9cb861e8!2sOctopus+Works!5e0!3m2!1sen!2s!4v1558306910389!5m2!1sen!2s" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
