  ...
  <style type="text/css">
    ...
    *,
    ...
    @media screen and (min-width: 300) {
      ...
      background-image:   url('../img/mobile/video/video.png');
    ...
    .img2 {
      ...
      background-size: cover;
      background-position: center center;
      background-image: url('../img/mobile/video/video1.png');
...
<body class="">
    ...
    @include('incs.nav')
      ...
      <div id="container" class="view jarallax custom-primary" data-jarallax='{"speed": 0.2}'>
          <div class="img1 z-depth-2 h-100   wow fadeInRightBig" data-wow-delay="0" >
            <div id="moveing" class=" moveing img2   h-100    wow fadeInLeftBig"  data-wow-delay="0.5s" > 
        ...
        <div class="mask ">
          ...
          <div  class="container h-100 d-inline-flex  ml-5  align-items-center">
            ...
            <div style="margin-bottom: 199px;" class="row smooth-scroll">
              ...
              <div class="col-6">
                ...
                <div class="wow fadeInUp ">
                  ...
                  <h2 class="display-3 font-weight-bold white-text mb-3"> <strong class="">Visual  </strong> <br> <strong class="">Production</strong>  </h2>
  ...
  <main>
    ...
    <div class="container">
      ...
      <!-- First row -->
      <div class="row  wow fadeIn mt-5" data-wow-delay="0.2s">
          ...
          <div class="col-lg-3 col-md-6 text-center mt-1">
            ...
            <div class="icon-area">
              ...
              <a
                ...
                <i class="fas fa-music d-flex  justify-content-center"></i>
  
              </a>
  
              <h6><strong class="font-weight-bold mb-3 pb-3">Music Videos</strong></h6>
          ...
          <div class="col-lg-3 col-md-6 text-center mt-1">
            ...
            <div class="icon-area">
              ...
              <a
                ...
                <i class="fas fa-calendar-alt d-flex justify-content-center"></i>
  
              </a>
  
              <h6><strong class="font-weight-bold mb-3 pb-3">Events</strong></h6>
          ...
          <div class="col-lg-3 col-md-6 text-center mt-1">
            ...
            <div class="icon-area">
              ...
              <a
                ...
                <i class="fas fa-film d-flex justify-content-center"></i>
  
              </a>
  
              <h6><strong class="font-weight-bold mb-3 pb-3">Documentary</strong></h6>
          ...
          <div class="col-lg-3 col-md-6 text-center mt-1">
            ...
            <div class="icon-area">
              ...
              <h6><strong class="font-weight-bold mb-3 pb-3">Commercial</strong></h6>
      ...
      <section id="portfolio" class="section pb-5">
        ...
        <h2 class="text-uppercase text-center font-weight-bold custom-primary-text my-4 pt-5 wow fadeIn"
          data-wow-delay="0.2s">Our Photos</h2>
    ...
    <div class="streak streak-photo streak-md"
      style="background-image:url('/img/film.jpg')">

      <div class="mask flex-center rgba-indigo-strong">

        <div class="white-text smooth-scroll mx-4">

            <h2 class="h2-responsive white-text mt-4 wow fadeIn" data-wow-delay="0.2s"><i class="fas fa-quote-left"
                aria-hidden="true"></i> A camera is a tool for learning how to see without a camera. <i
